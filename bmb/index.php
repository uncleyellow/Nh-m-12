    ...
    <div class="container">
        <div id="ant-layout">
            <section class="search-quan">
                ...
                <form action="thucdon.php" method="GET">
                    <input name="search" type="text" placeholder="Tìm kiếm" style="background-color: white;">
                </form>
            </section>
                        ...
                        echo '
                                    <div class="box">
                                        <a href="thucdon.php?id_category=' . $item['id'] . '">
                                            ...
                                            <div class="bg"></div>
                                            <img src="images/bg/category1.jpg" alt="">
                                        </a>
        ...
        <section class="main">
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Sản Phẩm Hot <span class="black">BMB SHOP</span></h1>
                </div>
